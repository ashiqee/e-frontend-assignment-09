...
import EditCouponModal from '../Modals/CouponsModal/EditCouponModal';
import DeleteCouponModal from '../Modals/CouponsModal/DeleteCouponModal';


const CouponDropDownAction = ({id,isDeleted,data}:
    {id:string , 
    isDeleted:boolean,
    data:any}) => {
    ...
    return (
        ...
        {
            isOpen && <EditCouponModal exitsData={data} id={id} setIsOpen={setIsOpen}/>
        }
        {
            isDeleteOpen && <DeleteCouponModal id={id} setIsOpen={setIsDelOpen} status={status}/>
        }
...
export default CouponDropDownAction;